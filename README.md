•	Developed a job comparison app that allows users to input and compare offers based on salary, bonuses, and benefits, resulting in a 30% reduction in time spent on job comparisons.
